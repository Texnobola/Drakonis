...
import net.mcreator.drakonis.client.model.IcyBootsModel;
...
@EventBusSubscriber
public abstract class IcyBootsItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			10f, 0.5f);
			registerHelper.register(ResourceLocation.fromNamespaceAndPath("drakonis", "icy_boots"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					IcyBootsModel bootsModel = new IcyBootsModel(Minecraft.getInstance().getEntityModels().bakeLayer(IcyBootsModel.LAYER_LOCATION));
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelPart(Collections.emptyList(), Collections.emptyMap()),
									...
									"right_leg", bootsModel.right_boot, 
									"left_leg", bootsModel.left_boot)));
				}
		...
		}, DrakonisModItems.ICY_BOOTS_BOOTS.get());
	}

	@SubscribeEvent
	@OnlyIn(Dist.CLIENT)
	public static void registerLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions event) {
		event.registerLayerDefinition(IcyBootsModel.LAYER_LOCATION, IcyBootsModel::createBodyLayer);
	}

	public IcyBootsItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Boots extends IcyBootsItem {
		public Boots() {
