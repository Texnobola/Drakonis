...
public class IcyHelmetModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition helmet = partdefinition.addOrReplaceChild("helmet", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-4.5F, 14.0F, -4.5F, 9.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-4.0F, 12.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-5.0F, 17.0F, -5.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(4.0F, 17.0F, -5.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-2.0F, 8.0F, -4.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-1.0F, 5.0F, -3.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-3.0F, 17.0F, -4.2F, 2.0F, 1.0F, 0.3F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(1.0F, 17.0F, -4.2F, 2.0F, 1.0F, 0.3F, new CubeDeformation(0.0F)),
		...
		PartDefinition Back_Plate_Upper_r1 = helmet.addOrReplaceChild("Back_Plate_Upper_r1",
				...
				PartPose.offsetAndRotation(0.0F, 14.0F, 4.0F, 0.3927F, 0.0F, 0.0F));
		...
		PartDefinition Back_Plate_Lower_r1 = helmet.addOrReplaceChild("Back_Plate_Lower_r1",
				...
				PartPose.offsetAndRotation(0.0F, 20.0F, 4.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition Horn_Tip_Right_r1 = helmet.addOrReplaceChild("Horn_Tip_Right_r1",
				...
				PartPose.offsetAndRotation(7.0F, 11.0F, -0.5F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition Horn_Base_Right_r1 = helmet.addOrReplaceChild("Horn_Base_Right_r1",
				...
				PartPose.offsetAndRotation(4.0F, 15.0F, -1.0F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition Chin_Spike_r1 = helmet.addOrReplaceChild("Chin_Spike_r1",
				...
				PartPose.offsetAndRotation(0.0F, 20.0F, -5.0F, 0.3927F, 0.0F, 0.0F));
